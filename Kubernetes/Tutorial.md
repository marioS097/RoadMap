...
> kubectl get pods
13. Usar el comando **describe** dará más información
> kubectl describe pods
14. Si no hay ninguna imagen llamada *v10*, volver a la version anterior
> kubectl rollout undo deployments/kubernetes-bootcamp
- El comando **rollout** revierte el despliegue al estado anterior conocido
15. Volver a listar los Pods
> kubectl get pods
16. Comprobar la imagen desplegada en ellos
> kubectl describe pods